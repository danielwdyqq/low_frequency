...
\title{Taking One Small Step Forward:\\Finding Low-Frequency Items in Data Streams}
...
\begin{abstract}
%\boldmath
Low-frequency items in data streams are becoming more and more important due to their large amount, and the ability to excavate the rich information contained in them is of great significance to many companies and organizations. We propose an one-pass algorithm, called \emph{BFSS}, which can find items in a data stream with frequencies less than a user specified support. Our algorithm is simple and have small memory footprints. Although the output is approximate, we can guarantee the recall of \emph{BFSS} is always 1 and the precision is high enough. Given a little modification, \emph{BFSS} can be improved to \emph{SBFSS}, which can handle data streams in limited and small space and gurantee a high precision together with a theoretically bounded recall. The experimental results tested on real data set show the recall of \emph{BFSS} was 1 and the precision was above 0.95 using much less space compared to \emph{nCount} and \emph{rCount}, which are two naive methods finding low-frequency items in data streams. \emph{SBFSS} outperformed \emph{lCount}, a method finding low-frequency items in data streams using limited space with replacement strategy, in both precision and recall.
\end{abstract}
...
\centering
	\begin{minipage}{0.4\linewidth}
	   \centering
	   \subfloat[Recall for 0.001-BLFE]{\includegraphics[width=2.8in]{png/recall.png}\label{subfig:recall}}
	\end{minipage}
	\begin{minipage}{0.4\linewidth}
	   \centering
	   \subfloat[Precision for 0.001-BLFE]{\includegraphics[width=2.8in]{png/precision.png}\label{subfig:precison}}
	\end{minipage}
	\begin{minipage}{0.4\linewidth}
	   \centering
	   \subfloat[$F_1$ for 0.001-BLFE]{\includegraphics[width=2.8in]{png/f1.png}\label{subfig:f1}}
	\end{minipage}
	\begin{minipage}{0.4\linewidth}
	   \centering
	   \subfloat[Space for 0.001-BLFE]{\includegraphics[width=2.8in]{png/space.png}\label{subfig:space}}
	\end{minipage}
...
\hline
&&&&&&&&&&\IEEEeqnarraymulticol{7}{t}{Precision}&&&\IEEEeqnarraymulticol{7}{t}{Recall}&\\ &\hfill\raisebox{-2pt}[0pt][0pt]{$\phi$}\hfill&&&\hfill\raisebox{-2pt}[0pt][0pt]{$K$}\hfill&&&\hfill\raisebox{-2pt}[0pt][0pt]{Space}\hfill&&\IEEEeqnarraymulticol{18}{h}{}%
...
\hline
&&&&&&&\IEEEeqnarraymulticol{7}{t}{Precision (SBFSS / lCount)}&&&\IEEEeqnarraymulticol{7}{t}{Recall (SBFSS / lCount)}&\\ &\hfill\raisebox{-2pt}[0pt][0pt]{$\phi$}\hfill&&&\hfill\raisebox{-2pt}[0pt][0pt]{Space}\hfill&&\IEEEeqnarraymulticol{18}{h}{}%
\IEEEeqnarraystrutsize{0pt}{0pt}\\ 
&&&&&&&\hfill N=10^7\hfill&&\hfill N=3\times 10^7\hfill&&\hfill N=5\times 10^7\hfill&&\hfill N=7\times 10^7\hfill&&&\hfill N=10^7\hfill&&\hfill N=3\times 10^7\hfill&&\hfill N=5\times 10^7\hfill&&\hfill N=7\times 10^7\hfill&\IEEEeqnarraystrutsizeadd{0pt}{2pt}\\ 
\IEEEeqnarraydblrulerowcut\\ 
&\hfill\raisebox{-13pt}[0pt][0pt]{0.01}\hfill
...
\begin{figure*}[!t]
	...
	\begin{minipage}{0.4\linewidth}
		\centering
		\subfloat[$\phi$=0.01, Space=72KB]{\includegraphics[width=2.8in]{png/001_72KB.png}}
	\end{minipage}
	\begin{minipage}{0.4\linewidth}
		\centering
		\subfloat[$\phi$=0.01, Space=108KB]{\includegraphics[width=2.8in]{png/001_108KB.png}}
	\end{minipage}
	\begin{minipage}{0.4\linewidth}
		\centering
		\subfloat[$\phi$=0.001, Space=72KB]{\includegraphics[width=2.8in]{png/0001_72KB.png}}
	\end{minipage}
	\begin{minipage}{0.4\linewidth}
		\centering
		\subfloat[$\phi$=0.001, Space=108KB]{\includegraphics[width=2.8in]{png/0001_108KB.png}\label{subfig:f1_4}}
	\end{minipage}
	\caption{Performance Comparison of $F_1$ between \emph{SBFSS} and \emph{lCount} - Varying $\phi$ and Space }
	\label{fig:F1}
\end{figure*}
