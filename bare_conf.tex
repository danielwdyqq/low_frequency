...
This section presents problem statement and some representative algorithms solvimg $\epsilon$\emph{-Deficient Frequent Elements} \cite{IEEEexample:sticky} which will be formally defined below. Table \ref{tab:list} summarizes the major notations in this paper.
...
Our goal is to calculate the maximum value of $E(\#FPs)$ for different values of $n$ when the values of $H$ and $K$ are confirmed. Let $F'=(M-n)(1-(1-\frac{1}{K})^{Hn})^H$, and from Inequation \ref{eq:8}, we have $E(\#FPs)\leq F'+\lfloor\frac{1}{s}\rfloor$, in which the value of $\lfloor\frac{1}{s}\rfloor$ is confirmed once the value of $s$ is confirmed, therefore our task is to calculate the maximum value of $F'$.
...
\centering
	\begin{minipage}{0.23\linewidth}
		\centering
		\subfloat[Recall for $1\%$-BLFE]{\includegraphics[width=1.95in]{png/001_recall.png}\label{subfig:001_recall}}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
		\centering
		\subfloat[Precision for $1\%$-BLFE]{\includegraphics[width=1.95in]{png/001_precision.png}\label{subfig:001_precison}}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
		\centering
		\subfloat[$F_1$ for $1\%$-BLFE]{\includegraphics[width=1.95in]{png/001_f1.png}\label{subfig:001_f1}}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
		\centering
		\subfloat[Space for $1\%$-BLFE]{\includegraphics[width=1.95in]{png/001_space.png}\label{subfig:001_space}}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
		\centering
		\subfloat[Recall for $0.2\%$-BLFE]{\includegraphics[width=1.95in]{png/0002_recall.png}\label{subfig:0002_recall}}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
		\centering
		\subfloat[Precision for $0.2\%$-BLFE]{\includegraphics[width=1.95in]{png/0002_precision.png}\label{subfig:0002_precison}}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
		\centering
		\subfloat[$F_1$ for $0.2\%$-BLFE]{\includegraphics[width=1.95in]{png/0002_f1.png}\label{subfig:0002_f1}}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
		\centering
		\subfloat[Space for $0.2\%$-BLFE]{\includegraphics[width=1.95in]{png/0002_space.png}\label{subfig:0002_space}}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
	   \centering
	   \subfloat[Recall for $0.1\%$-BLFE]{\includegraphics[width=1.95in]{png/recall.png}\label{subfig:recall}}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
	   \centering
	   \subfloat[Precision for $0.1\%$-BLFE]{\includegraphics[width=1.95in]{png/precision.png}\label{subfig:precison}}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
	   \centering
	   \subfloat[$F_1$ for $0.1\%$-BLFE]{\includegraphics[width=1.95in]{png/f1.png}\label{subfig:f1}}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
	   \centering
	   \subfloat[Space for $0.1\%$-BLFE]{\includegraphics[width=1.95in]{png/space.png}\label{subfig:space}}
	\end{minipage}
	\caption{ Performance Comparison between \emph{BFSS}, \emph{nCount} and \emph{rCount} Using Real Data - Varying $s,N$ }
	\label{fig:performance comparison of BFSS}
\end{figure*}

\begin{table*}[!t] 
\centering 
\caption{ Performance of \emph{BFSS} Using Real Data - Varying $s$, $K$ and $N$ } 
\label{tab:bfss} 
...
\hline
&&&&&&&&&&\IEEEeqnarraymulticol{7}{t}{Precision}&&&\IEEEeqnarraymulticol{7}{t}{Recall}&\\ &\hfill\raisebox{-2pt}[0pt][0pt]{$s$}\hfill&&&\hfill\raisebox{-2pt}[0pt][0pt]{$K$}\hfill&&&\hfill\raisebox{-2pt}[0pt][0pt]{Space}\hfill&&\IEEEeqnarraymulticol{18}{h}{}%
...
\IEEEeqnarraystrutsize{0pt}{0pt}\\
&&&&270000&&&103KB&&&0.969&&0.959&&0.949&&0.943&&&1&&1&&1&&1&\\ 
&&&&400000&&&120KB&&&0.984&&0.979&&0.974&&0.972&&&1&&1&&1&&1&\\ 
&&&&800000&&&170KB&&&0.996&&0.994&&0.993&&0.992&&&1&&1&&1&&1&\\ 
\hline
...
\begin{figure*}[!t]
	...
	\begin{minipage}{0.23\linewidth}
		\centering
		\subfloat[$s$=0.01, Space=54KB]{\includegraphics[width=1.95in]{png/001_54KB.png}}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
		\centering
		\subfloat[$s$=0.01, Space=72KB]{\includegraphics[width=1.95in]{png/001_72KB.png}}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
		\centering
		\subfloat[$s$=0.001, Space=54KB]{\includegraphics[width=1.95in]{png/0001_54KB.png}}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
		\centering
		\subfloat[$s$=0.001, Space=72KB]{\includegraphics[width=1.95in]{png/0001_72KB.png}\label{subfig:f1_4}}
	\end{minipage}
...
Now the key point is how to choose the appropriate values of $H$ and $K$. The
