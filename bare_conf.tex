...
Table \ref{tab:bfss} shows the performance of \emph{BFSS} with different parameter settings. We can see that the precision increased with the increasing of K, and once $K$ and $N$ were confirmed the precision was almost confirmed too, which means the value of $\phi$ had little affection on the precison of \emph{BFSS}, in fact, from the analysis above, we can also observe that \emph{BF} mainly influences the accuracy of \emph{BFSS}, and the precision of $$
