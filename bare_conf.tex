...
\begin{figure}[!t]
	...
	\begin{minipage}{0.45\linewidth}
		\centering
		\subfloat[]{\includegraphics[width=1.84in]{png/n.png}\label{subfig:n}}
	\end{minipage}
	\begin{minipage}{0.45\linewidth}
		\centering
		\subfloat[]{\includegraphics[width=1.84in]{png/F(n).png}\label{subfig:F(n)}}
	\end{minipage}
...
\centering
	...
	\begin{minipage}{0.23\linewidth}
	   \centering
	   \subfloat[Recall for $0.1\%$-BLFE]{\includegraphics[width=1.95in]{png/recall.png}\label{subfig:0001_recall}}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
	   \centering
	   \subfloat[Precision for $0.1\%$-BLFE]{\includegraphics[width=1.95in]{png/precision.png}\label{subfig:0001_precison}}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
	   \centering
	   \subfloat[$F_1$ for $0.1\%$-BLFE]{\includegraphics[width=1.95in]{png/f1.png}\label{subfig:0001_f1}}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
	   \centering
	   \subfloat[Space for $0.1\%$-BLFE]{\includegraphics[width=1.95in]{png/space.png}\label{subfig:0001_space}}
	\end{minipage}
	\caption{ Performance Comparison between \emph{BFSS}, \emph{nCount} and \emph{rCount} Using Real Data - Varying $s,\epsilon$ and $N$ }
